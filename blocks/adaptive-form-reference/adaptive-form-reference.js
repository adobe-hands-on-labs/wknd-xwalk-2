...
async function generateForm(fieldDiv, formImg, containerId, formPath) {
  const formurl = `https://author-p51114-e1463484.adobeaemcloud.com${formPath}.-1.json`;
  const response = await fetch(formurl);
    if (response.ok) {
      ...
      imgElement.src = formImg ? formImg : 'https://author-p51114-e1463484.adobeaemcloud.com/content/dam/aemcshol/mobile/adobestock-185324648.jpg'; // Set the image URL here
